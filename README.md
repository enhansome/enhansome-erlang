...
* [cowboy](https://github.com/ninenines/cowboy) ⭐ 7,521 | 🐛 67 | 🌐 Erlang | 📅 2026-09-16 - A simple HTTP server.
...
* [Zotonic](https://github.com/zotonic/zotonic) ⭐ 847 | 🐛 195 | 🌐 Erlang | 📅 2026-09-24 - High speed, real-time web framework and content management system.
* [Axiom](https://github.com/tsujigiri/axiom) ⭐ 264 | 🐛 6 | 🌐 Erlang | 📅 2023-02-16 - A micro-framework, inspired by Ruby's [Sinatra](https://github.com/sinatra/sinatra) ⭐ 12,456 | 🐛 47 | 🌐 Ruby | 📅 2026-07-20.
...
* [hackney](https://github.com/benoitc/hackney) ⭐ 1,417 | 🐛 14 | 🌐 Erlang | 📅 2026-09-24 - Simple HTTP client in Erlang.
...
* [Concuerror](https://github.com/parapluu/Concuerror) ⭐ 349 | 🐛 17 | 🌐 Erlang | 📅 2026-06-24 - Concuerror is a systematic testing tool for concurrent Erlang programs.
...
* [rebar3](https://github.com/rebar/rebar3) ⭐ 1,819 | 🐛 226 | 🌐 Erlang | 📅 2026-09-22 - A build tool for Erlang which can manage Erlang packages from [Hex.pm](https://hex.pm/). See more at [rebar3.org](https://www.rebar3.org/)
