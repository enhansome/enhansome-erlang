...
A curated list of amazingly awesome Erlang libraries, resources and shiny thing inspired by [awesome-elixir](https://github.com/h4cc/awesome-elixir) ⭐ 13,167 | 🐛 36 | 🌐 Elixir | 📅 2025-10-12.
...
* [relx](https://github.com/erlware/relx) ⭐ 694 | 🐛 84 | 🌐 Erlang | 📅 2026-03-24 - A release assembler for Erlang.
...
* [cowboy](https://github.com/ninenines/cowboy) ⭐ 7,522 | 🐛 65 | 🌐 Erlang | 📅 2026-09-16 - A simple HTTP server.
...
* [Zotonic](https://github.com/zotonic/zotonic) ⭐ 847 | 🐛 195 | 🌐 Erlang | 📅 2026-09-20 - High speed, real-time web framework and content management system.
* [Axiom](https://github.com/tsujigiri/axiom) ⭐ 264 | 🐛 6 | 🌐 Erlang | 📅 2023-02-16 - A micro-framework, inspired by Ruby's [Sinatra](https://github.com/sinatra/sinatra) ⭐ 12,451 | 🐛 46 | 🌐 Ruby | 📅 2026-07-20.
* [Giallo](https://github.com/kivra/giallo) ⚠️ Archived - A small and flexible web framework on top of [Cowboy](https://github.com/ninenines/cowboy) ⭐ 7,522 | 🐛 65 | 🌐 Erlang | 📅 2026-09-16.

## Web Framework Components

*Standalone component from web development frameworks.*

* [simple\_bridge](https://github.com/nitrogen/simple_bridge) ⭐ 113 | 🐛 17 | 🌐 Erlang | 📅 2026-07-27 - An abstraction layer providing a unified interface to popular Erlang web servers (Cowboy, Inets, Mochiweb, Webmachine, and Yaws).
...
* [hackney](https://github.com/benoitc/hackney) ⭐ 1,417 | 🐛 15 | 🌐 Erlang | 📅 2026-09-03 - Simple HTTP client in Erlang.
* [gun](https://github.com/ninenines/gun) ⭐ 948 | 🐛 24 | 🌐 Erlang | 📅 2026-09-08 - Erlang HTTP client with support for HTTP/1.1, SPDY and Websocket.
...
* [eper](https://github.com/massemanet/eper) ⭐ 439 | 🐛 5 | 🌐 Erlang | 📅 2018-07-06 - A loose collection of Erlang Performance related tools.
...
* [eflame](https://github.com/proger/eflame) ⭐ 428 | 🐛 6 | 🌐 Perl | 📅 2023-12-13 - A Flame Graph profiler for Erlang.
* [Concuerror](https://github.com/parapluu/Concuerror) ⭐ 348 | 🐛 17 | 🌐 Erlang | 📅 2026-06-24 - Concuerror is a systematic testing tool for concurrent Erlang programs.
...
* [rebar3](https://github.com/rebar/rebar3) ⭐ 1,818 | 🐛 229 | 🌐 Erlang | 📅 2026-09-20 - A build tool for Erlang which can manage Erlang packages from [Hex.pm](https://hex.pm/). See more at [rebar3.org](https://www.rebar3.org/)
...
* [erl-rstar](https://github.com/armon/erl-rstar) ⭐ 59 | 🐛 0 | 🌐 Erlang | 📅 2018-07-11 - An Erlang implementation of the R\*-tree spacial data structure.
...
* [tx](https://github.com/kvakvs/tx) ⭐ 82 | 🐛 1 | 🌐 CSS | 📅 2014-10-08 - An HTML Erlang term viewer, starts own webserver and displays any term you give it from your Erlang node.
...
* [leptus](https://github.com/s1n4/leptus) ⭐ 345 | 🐛 5 | 🌐 Erlang | 📅 2021-05-13 - Leptus is an Erlang REST framework that runs on top of cowboy.
...
* [ranch](https://github.com/ninenines/ranch) ⭐ 1,242 | 🐛 5 | 🌐 Erlang | 📅 2026-09-08 - Socket acceptor pool for TCP protocols.
...
* [Erlang Bookmarks](https://github.com/0xAX/erlang-bookmarks/wiki/Erlang-bookmarks) ⭐ 1,155 | 🐛 0 | 📅 2021-07-31 - All about erlang programming language \[powerd by community].
